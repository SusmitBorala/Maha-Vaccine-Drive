...
public class RegistrationPage extends JFrame {
	...
	public RegistrationPage() {
		...
		closeLabel.setIcon(new ImageIcon(RegistrationPage.class.getResource("/com/mvd/resources/exitButton.png")));
		...
		headerImg.setIcon(new ImageIcon(RegistrationPage.class.getResource("/com/mvd/resources/h1.jpg")));
		...
		RegisterLabel.setIcon(new ImageIcon(RegistrationPage.class.getResource("/com/mvd/resources/bg.png")));
		...
		backgroundImg.setIcon(new ImageIcon(RegistrationPage.class.getResource("/com/mvd/resources/bg.png")));
